...
class LinksFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'shortened' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'user_id' => 1,
            'category_id' => 1,
            'created' => '2016-10-04 10:40:06',
            'modified' => '2016-10-04 10:40:06'
        ],
    ];
}
